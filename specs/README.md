...
- [Evolve a sovereign node runtime journey](journeys/evolve-a-sovereign-node-runtime.md)
- [Place synchronization inside the node runtime story](stories/node-runtime/place-synchronization-inside-node-runtime.md)
- [Declare host capabilities without domain authority story](stories/node-runtime/declare-host-capabilities-without-domain-authority.md)
- [Observe node-boundary coherence story](stories/node-runtime/observe-boundary-coherence.md)
- [Promote a compatible node runtime story](stories/node-runtime/promote-compatible-node-runtime.md)
- [Sovereign node runtime boundary](architecture/node-runtime-boundary-v0.1.md)
- [Sovereign node runtime model](models/node-runtime/node-runtime.model.yaml)
- [Sovereign node runtime lifecycle](models/node-runtime/node-runtime.lifecycle.yaml)
- [Node synchronization session model](models/node-runtime/sync-session.model.yaml)
- [Node synchronization lifecycle](models/node-runtime/sync-session.lifecycle.yaml)
- [Coherence observation model](models/node-runtime/coherence-observation.model.yaml)
- [Host capability manifest model](models/node-host/host-capability-manifest.model.yaml)
- [Replication cursor model](models/shared/replication-cursor.model.yaml)
- [Node runtime boundary capability](capabilities/node-runtime-boundary.capability.yaml)
